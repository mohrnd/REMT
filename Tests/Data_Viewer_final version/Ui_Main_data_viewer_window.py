...
# Form implementation generated from reading ui file 'c:\Users\BALLS2 (rip BALLS)\Desktop\REMT\Tests\Data_Viewer_final version\Main_data_viewer_window.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.CardWidget.setGeometry(QtCore.QRect(10, 370, 1061, 941))
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.LastHourTab)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 1041, 861))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.CPURAMDISKLastHour = QtWidgets.QFrame(self.verticalLayoutWidget_2)
        self.CPURAMDISKLastHour.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.CPURAMDISKLastHour.setFrameShadow(QtWidgets.QFrame.Raised)
        self.CPURAMDISKLastHour.setObjectName("CPURAMDISKLastHour")
        self.verticalLayout_4.addWidget(self.CPURAMDISKLastHour)
        self.LoadsLastHour = QtWidgets.QFrame(self.verticalLayoutWidget_2)
        self.LoadsLastHour.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.LoadsLastHour.setFrameShadow(QtWidgets.QFrame.Raised)
        self.LoadsLastHour.setObjectName("LoadsLastHour")
        self.verticalLayout_4.addWidget(self.LoadsLastHour)
        self.NetworkLastHour = QtWidgets.QFrame(self.verticalLayoutWidget_2)
        self.NetworkLastHour.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.NetworkLastHour.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.Last24HoursTab)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 1041, 861))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.CPURAMDISKLast24Hours = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        self.CPURAMDISKLast24Hours.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.CPURAMDISKLast24Hours.setFrameShadow(QtWidgets.QFrame.Raised)
        self.CPURAMDISKLast24Hours.setObjectName("CPURAMDISKLast24Hours")
        self.verticalLayout_5.addWidget(self.CPURAMDISKLast24Hours)
        self.LoadsLast24Hours = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        self.LoadsLast24Hours.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.LoadsLast24Hours.setFrameShadow(QtWidgets.QFrame.Raised)
        self.LoadsLast24Hours.setObjectName("LoadsLast24Hours")
        self.verticalLayout_5.addWidget(self.LoadsLast24Hours)
        self.NetworkLast24Hours = QtWidgets.QFrame(self.verticalLayoutWidget_3)
        self.NetworkLast24Hours.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.NetworkLast24Hours.setFrameShadow(QtWidgets.QFrame.Raised)
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(0, 10, 1041, 75))
        ...
        self.verticalLayoutWidget_8 = QtWidgets.QWidget(self.CustomTab)
        self.verticalLayoutWidget_8.setGeometry(QtCore.QRect(0, 90, 1041, 771))
        self.verticalLayoutWidget_8.setObjectName("verticalLayoutWidget_8")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_8)
        self.verticalLayout_10.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.CPURAMDISKCustom = QtWidgets.QFrame(self.verticalLayoutWidget_8)
        self.CPURAMDISKCustom.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.CPURAMDISKCustom.setFrameShadow(QtWidgets.QFrame.Raised)
        self.CPURAMDISKCustom.setObjectName("CPURAMDISKCustom")
        self.verticalLayout_10.addWidget(self.CPURAMDISKCustom)
        self.LoadsCustom = QtWidgets.QFrame(self.verticalLayoutWidget_8)
        self.LoadsCustom.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.LoadsCustom.setFrameShadow(QtWidgets.QFrame.Raised)
        self.LoadsCustom.setObjectName("LoadsCustom")
        self.verticalLayout_10.addWidget(self.LoadsCustom)
        self.NetworkCustom = QtWidgets.QFrame(self.verticalLayoutWidget_8)
        self.NetworkCustom.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.NetworkCustom.setFrameShadow(QtWidgets.QFrame.Raised)
