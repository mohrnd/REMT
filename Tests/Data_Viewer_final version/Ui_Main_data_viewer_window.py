...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.CardWidget.setGeometry(QtCore.QRect(10, 370, 1061, 541))
        ...
        self.LastHourTabGraphs = QtWidgets.QStackedWidget(self.LastHourTab)
        self.LastHourTabGraphs.setGeometry(QtCore.QRect(10, 10, 1021, 441))
        self.LastHourTabGraphs.setObjectName("LastHourTabGraphs")
        self.NetworkGraphs = QtWidgets.QWidget()
        self.NetworkGraphs.setObjectName("NetworkGraphs")
        self.CardWidget_2 = CardWidget(self.NetworkGraphs)
        self.CardWidget_2.setGeometry(QtCore.QRect(320, 40, 16, 16))
        self.CardWidget_2.setObjectName("CardWidget_2")
        self.PushButton_2 = PushButton(self.NetworkGraphs)
        self.PushButton_2.setGeometry(QtCore.QRect(220, 70, 102, 32))
        self.PushButton_2.setObjectName("PushButton_2")
        self.LastHourTabGraphs.addWidget(self.NetworkGraphs)
        self.LoadAveragesgraphs = QtWidgets.QWidget()
        self.LoadAveragesgraphs.setObjectName("LoadAveragesgraphs")
        self.CardWidget_3 = CardWidget(self.LoadAveragesgraphs)
        self.CardWidget_3.setGeometry(QtCore.QRect(230, 40, 16, 16))
        self.CardWidget_3.setObjectName("CardWidget_3")
        self.PushButton_3 = PushButton(self.LoadAveragesgraphs)
        self.PushButton_3.setGeometry(QtCore.QRect(350, 100, 102, 32))
        self.PushButton_3.setObjectName("PushButton_3")
        self.LastHourTabGraphs.addWidget(self.LoadAveragesgraphs)
        self.CPUandRamGraphs = QtWidgets.QWidget()
        self.CPUandRamGraphs.setObjectName("CPUandRamGraphs")
        self.CardWidget_4 = CardWidget(self.CPUandRamGraphs)
        self.CardWidget_4.setGeometry(QtCore.QRect(240, 50, 16, 16))
        self.CardWidget_4.setObjectName("CardWidget_4")
        self.PushButton_4 = PushButton(self.CPUandRamGraphs)
        self.PushButton_4.setGeometry(QtCore.QRect(270, 110, 102, 32))
        self.PushButton_4.setObjectName("PushButton_4")
        self.LastHourTabGraphs.addWidget(self.CPUandRamGraphs)
        self.DiskGraphs = QtWidgets.QWidget()
        self.DiskGraphs.setObjectName("DiskGraphs")
        self.PushButton = PushButton(self.DiskGraphs)
        self.PushButton.setGeometry(QtCore.QRect(260, 60, 102, 32))
    ...
    def retranslateUi(self, Form):
        ...
        self.PushButton_3.setText(_translate("Form", "Push button"))
        self.PushButton_4.setText(_translate("Form", "Push button"))
...
from qfluentwidgets import BodyLabel, CalendarPicker, CaptionLabel, CardWidget, ElevatedCardWidget, HorizontalSeparator, LineEdit, PrimaryPushButton, ProgressRing, PushButton, StrongBodyLabel, SubtitleLabel, TimePicker
