...
if __name__ == "__main__":
    ...
    commands4 = [f"echo 'yum check-update > /home/{username}/Bureau/check-update.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    #localpath = rf'../../REMT/Tests/LOGS/var/logs/{machine_name}/check-update.txt'
    localpath = rf'Tests/LOGS/var/logs/{machine_name}/journal/check-update.txt'

    # Chemin distant du fichier que vous souhaitez télécharger
    remotepath = f"/home/{username}/Bureau/check-update.txt"
    ...
    commands8= [f'rm Bureau/check-update.txt']
    # Exécution des commandes sans sudo 
