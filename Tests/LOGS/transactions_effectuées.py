...
def  fetch24 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'yum history list > /home/{username}/Bureau/transactions.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/transactions.txt"
    ...
    commands8= [f'rm Bureau/transactions.txt']
    # Exécution des commandes sans sudo 
