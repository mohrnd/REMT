...
def  fetch16 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p crit > /home/{username}/Desktop/system_critical.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/system_critical.txt'
    ...
    remotepath = f"/home/{username}/Desktop/system_critical.txt"
    ...
    commands8= [f'rm Desktop/system_critical.txt']
    # Exécution des commandes sans sudo 
