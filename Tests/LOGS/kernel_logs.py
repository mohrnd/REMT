...
def  fetch12 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'dmesg > /home/{username}/Bureau/Kernel_logs.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/Kernel_logs.txt"
    ...
    commands8= [f'rm Bureau/Kernel_logs.txt']
    # Exécution des commandes sans sudo 
