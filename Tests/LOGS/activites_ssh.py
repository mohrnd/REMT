...
def  fetch6 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f'echo "journalctl | grep \\"sshd\\" > /home/{username}/Desktop/ssh_events.txt" > /home/{username}/Desktop/test.sh']
    ...
    add = rf'{machine_name}/{machine_name}__{date_aujourdhui}/journal/ssh_events.txt'
    ...
    remotepath = f"/home/{username}/Desktop/ssh_events.txt"
    ...
    commands8= [f'rm Desktop/ssh_events.txt']
    # Exécution des commandes sans sudo 
