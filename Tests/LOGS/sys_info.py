...
def  fetch20 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'journalctl -p info > /home/{username}/Bureau/system_info.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/system_info.txt"
    ...
    commands8= [f'rm Bureau/system_info.txt']
    # Exécution des commandes sans sudo 
