...
def  fetch20 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p info > /home/{username}/Desktop/system_info.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/system_info.txt'
    ...
    remotepath = f"/home/{username}/Desktop/system_info.txt"
    ...
    commands8= [f'rm Desktop/system_info.txt']
    # Exécution des commandes sans sudo 
