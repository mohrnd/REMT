...
def  fetch15 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'journalctl -p alert > /home/{username}/Bureau/system_alert.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/system_alert.txt"
    ...
    commands8= [f'rm Bureau/system_alert.txt']
    # Exécution des commandes sans sudo 
