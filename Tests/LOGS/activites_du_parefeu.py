...
def  fetch3 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f'echo "journalctl | grep \\"firewall\\" > /home/{username}/Bureau/Firewall_events.txt" > /home/{username}/Bureau/test.sh']
    ...
    commands8= [f'rm Bureau/Firewall_events.txt']
    # Exécution des commandes sans sudo 
