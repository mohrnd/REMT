...
def  fetch5 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f'echo "journalctl | grep \\"Network\\" > /home/{username}/Desktop/Network_events.txt" > /home/{username}/Desktop/test.sh']
    ...
    add = rf'{machine_name}/{filename}/journal/Network_events.txt'
    ...
    remotepath = f"/home/{username}/Desktop/Network_events.txt"
    ...
    commands8= [f'rm Desktop/Network_events.txt']
    # Exécution des commandes sans sudo 
