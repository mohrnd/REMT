...
def  fetch7 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'dmesg | grep usb > /home/{username}/Bureau/usb_events.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/usb_events.txt"
    ...
    commands8= [f'rm Bureau/usb_events.txt']
    # Exécution des commandes sans sudo 
