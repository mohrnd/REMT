...
if __name__ == "__main__":
    ...
    commands4 = [f"echo 'df -h > /home/{username}/Bureau/utilisation_disque.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    localpath =  rf'Tests/LOGS/var/logs/{machine_name}/{machine_name}__{date_aujourdhui}/journal/utilisation_disque.txt'

    # Chemin distant du fichier que vous souhaitez télécharger
    remotepath = f"/home/{username}/Bureau/utilisation_disque.txt"
    ...
    commands8= [f'rm Bureau/utilisation_disque.txt']
    # Exécution des commandes sans sudo 
