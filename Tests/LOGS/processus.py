...
def  fetch13 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'ps aux > /home/{username}/Bureau/processus.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/processus.txt"
    ...
    commands8= [f'rm Bureau/processus.txt']
    # Exécution des commandes sans sudo 
