...
def  fetch13 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'ps aux > /home/{username}/Desktop/processus.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/processus.txt'
    ...
    remotepath = f"/home/{username}/Desktop/processus.txt"
    ...
    commands8= [f'rm Desktop/processus.txt']
    # Exécution des commandes sans sudo 
...
#La commande ps aux est utilisée pour afficher des informations détaillées sur tous les processus en cours d'exécution sur le système.
