...
def  fetch21 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p notice > /home/{username}/Desktop/system_notice.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    remotepath = f"/home/{username}/Desktop/system_notice.txt"
