...
def  fetch18 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'journalctl -p emerg > /home/{username}/Bureau/system_emerg.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    add = rf'{machine_name}/{machine_name}__{date_aujourdhui}/journal/system_emerg.txt'
    ...
    remotepath = f"/home/{username}/Bureau/system_emerg.txt"
    ...
    commands8= [f'rm Bureau/system_emerg.txt']
    # Exécution des commandes sans sudo 
