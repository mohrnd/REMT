...
def  fetch19 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'journalctl -p err > /home/{username}/Bureau/system_error.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/system_error.txt"
    ...
    commands8= [f'rm Bureau/system_error.txt']
    # Exécution des commandes sans sudo 
