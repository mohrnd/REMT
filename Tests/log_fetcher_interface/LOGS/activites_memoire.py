...
def  fetch4 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'dmesg | grep -i memory > /home/{username}/Bureau/Memory_events.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    add = rf'{machine_name}/{machine_name}__{date_aujourdhui}/journal/Memory_events.txt'
    ...
    remotepath = f"/home/{username}/Bureau/Memory_events.txt"
    ...
    commands8= [f'rm Bureau/Memory_events.txt']
    # Exécution des commandes sans sudo 
