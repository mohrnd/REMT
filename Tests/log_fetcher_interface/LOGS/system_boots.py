...
def  fetch23 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'last reboot > /home/{username}/Bureau/boot_system.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    add = rf'{machine_name}/{machine_name}__{date_aujourdhui}/journal/boot_system.txt'
    ...
    remotepath = f"/home/{username}/Bureau/boot_system.txt"
    ...
    commands8= [f'rm Bureau/boot_system.txt']
    # Exécution des commandes sans sudo 
