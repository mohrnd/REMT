...
def  fetch22 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'journalctl -p warning > /home/{username}/Bureau/system_warning.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/system_warning.txt"
    ...
    commands8= [f'rm Bureau/system_warning.txt']
    # Exécution des commandes sans sudo 
