...
def  fetch10 (machine_name, ip_add, local_path_in):
    ...
    commands4 = [f"echo 'netstat -tuln > /home/{username}/Bureau/connexion_actives.txt' >> /home/{username}/Bureau/test.sh"]
    ...
    remotepath = f"/home/{username}/Bureau/connexion_actives.txt"
    ...
    commands8= [f'rm Bureau/connexion_actives.txt']
    # Exécution des commandes sans sudo 
