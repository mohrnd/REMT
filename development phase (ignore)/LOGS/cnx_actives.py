...
def  fetch10 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands22 = [f'source ~/.bashrc']
    # Exécution des commandes sans sudo 
    results22 = test_cron2(ssh_client, commands22, password)
    #print(results22)
    ...
    commands4 = [f"echo 'netstat -tuln > /home/{username}/Desktop/connexion_actives.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/connexion_actives.txt'
    ...
    remotepath = f"/home/{username}/Desktop/connexion_actives.txt"
    ...
    commands8= [f'rm Desktop/connexion_actives.txt']
    # Exécution des commandes sans sudo 
...
#La commande netstat -tuln est une commande couramment utilisée sur les systèmes Linux pour afficher les connexions réseau actives ainsi que les ports auxquels des processus locaux sont en train de "écouter" (en attente de connexion entrante)