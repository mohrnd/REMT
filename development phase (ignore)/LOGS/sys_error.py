...
def  fetch19 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p err > /home/{username}/Desktop/system_error.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/system_error.txt'
    ...
    remotepath = f"/home/{username}/Desktop/system_error.txt"
    ...
    commands8= [f'rm Desktop/system_error.txt']
    # Exécution des commandes sans sudo 
