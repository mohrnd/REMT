...
#pour connaitre chaque installation,mise à jour ou suppression de packages effectués dans le systeme
...
def  fetch24 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'yum history list > /home/{username}/Desktop/transactions.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/transactions.txt'
    ...
    remotepath = f"/home/{username}/Desktop/transactions.txt"
    ...
    commands8= [f'rm Desktop/transactions.txt']
    # Exécution des commandes sans sudo 
