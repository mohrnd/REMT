...
def  fetch15 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p alert > /home/{username}/Desktop/system_alert.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/system_alert.txt'
    ...
    remotepath = f"/home/{username}/Desktop/system_alert.txt"
    ...
    commands8= [f'rm Desktop/system_alert.txt']
    # Exécution des commandes sans sudo 
