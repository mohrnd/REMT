...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.Deploy.setText(QCoreApplication.translate("Frame", u"Deploy", None))
        ...
        self.Title1.setText(QCoreApplication.translate("Frame", u"Deploy a file/folder:", None))
        self.LineEdit.setPlaceholderText(QCoreApplication.translate("Frame", u"Remote path (default /home/<username>/remt/)", None))
