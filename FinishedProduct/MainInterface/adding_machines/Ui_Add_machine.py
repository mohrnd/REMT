...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.MachineName.setGeometry(QtCore.QRect(10, 60, 780, 33))
        self.MachineName.setObjectName("MachineName")
        self.IPAddress = LineEdit(Form)
        self.IPAddress.setGeometry(QtCore.QRect(10, 110, 670, 33))
...
"FluentLabelBase{color:red}")
        ...
        self.SNMPv3USERNAME.setGeometry(QtCore.QRect(10, 340, 780, 33))
        ...
        self.SNMPv3PASSWORD.setGeometry(QtCore.QRect(10, 390, 780, 33))
        ...
        self.SNMPTIMEOUT.setGeometry(QtCore.QRect(10, 620, 780, 33))
        self.SNMPTIMEOUT.setObjectName("SNMPTIMEOUT")
        self.ADD_BUTTON = PrimaryPushButton(Form)
        self.ADD_BUTTON.setGeometry(QtCore.QRect(638, 720, 153, 32))
        self.ADD_BUTTON.setObjectName("ADD_BUTTON")
        self.PortForm = LineEdit(Form)
        self.PortForm.setGeometry(QtCore.QRect(690, 110, 101, 33))
        self.PortForm.setText("")
        self.PortForm.setObjectName("PortForm")
        ...
        self.EncryptionKey.setGeometry(QtCore.QRect(10, 570, 780, 33))
        self.EncryptionKey.setObjectName("EncryptionKey")
        self.ManagerIP = LineEdit(Form)
        self.ManagerIP.setGeometry(QtCore.QRect(10, 670, 780, 33))
    ...
    def retranslateUi(self, Form):
        ...
        self.SHACheckBox.setText(_translate("Form", "SHA"))
        ...
        self.PortForm.setPlaceholderText(_translate("Form", "Port"))
