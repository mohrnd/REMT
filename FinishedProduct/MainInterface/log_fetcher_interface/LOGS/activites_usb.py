...
def  fetch7 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'dmesg | grep usb > /home/{username}/Desktop/usb_events.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/usb_events.txt'
    ...
    remotepath = f"/home/{username}/Desktop/usb_events.txt"
    ...
    commands8= [f'rm Desktop/usb_events.txt']
    # Exécution des commandes sans sudo 
