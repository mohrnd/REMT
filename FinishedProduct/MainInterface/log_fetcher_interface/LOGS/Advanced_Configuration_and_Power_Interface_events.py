...
def  fetch8 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'dmesg | grep ACPI > /home/{username}/Desktop/ACPI_events.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/ACPI_events.txt'
    ...
    remotepath = f"/home/{username}/Desktop/ACPI_events.txt"
    ...
    commands8= [f'rm Desktop/ACPI_events.txt']
    # Exécution des commandes sans sudo 
