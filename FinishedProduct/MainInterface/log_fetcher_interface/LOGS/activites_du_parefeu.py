...
def  fetch3 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f'echo "journalctl | grep \\"firewall\\" > /home/{username}/Desktop/Firewall_events.txt" > /home/{username}/Desktop/test.sh']
    ...
    remotepath = f"/home/{username}/Desktop/Firewall_events.txt"
