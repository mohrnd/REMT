...
def  fetch11 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    add = rf'{machine_name}/{filename}/journal/device_detection.txt'
