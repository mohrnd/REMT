...
import csv
#dmesg est utilisée pour afficher les messages du noyau du système d'exploitation. Ces messages peuvent inclure des informations sur le démarrage du système, les événements matériels, les erreurs système et d'autres informations importantes sur le fonctionnement du noyau
...
def  fetch12 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'dmesg > /home/{username}/Desktop/Kernel_logs.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/Kernel_logs.txt'
    ...
    remotepath = f"/home/{username}/Desktop/Kernel_logs.txt"
    ...
    commands8= [f'rm Desktop/Kernel_logs.txt']
    # Exécution des commandes sans sudo 
