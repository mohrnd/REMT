...
def  fetch22 (machine_name, ip_add, password,port,username,host,hostname,local_path_in,csv_file,filename):
    ...
    commands4 = [f"echo 'journalctl -p warning > /home/{username}/Desktop/system_warning.txt' >> /home/{username}/Desktop/test.sh"]
    ...
    add = rf'{machine_name}/{filename}/journal/system_warning.txt'
    ...
    remotepath = f"/home/{username}/Desktop/system_warning.txt"
    ...
    commands8= [f'rm Desktop/system_warning.txt']
    # Exécution des commandes sans sudo 
